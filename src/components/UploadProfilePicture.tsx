...
import { updateUserProfileUrl } from "../features/user/userSlice";
...
const UploadProfilePicture = () => {
  ...
  const handleFileUpload = () => {
    try {
      ...
      fetch(url, {
        ...
        .then((res) => res.json())
        .then((data) => {
          dispatch(updateUserProfileUrl(data.url));
          dispatch(
            setModalOpen({
              isOpen: false,
              modalType: "",
  ...
  return (
    <Modal
      isOpen={isModalOpen.modalType === "PROFILE_PICTURE_UPLOAD" ? true : false}
    >
      <div
